...
public abstract class BaseCommand : Command
{
    ...
    {
        Options.Add(new Option<string?>(Constants.HOST_PARAMETER)
        {
            Description = "Target host name or domain",
        });

        Options.Add(new Option<string?>(Constants.USERNAME_PARAMETER)
        {
            Description = "SSH username"
        });

        Options.Add(new Option<string?>(Constants.PASSWORD_PARAMETER)
        {
            Description = "SSH password"
        });

        Options.Add(new Option<string?>(Constants.PRIVATE_KEY_PARAMETER)
        {
            Description = "SSH private key"
        });

        Options.Add(new Option<string?>(Constants.PROJECT_PARAMETER)
        {
            Description = "Project path",
        });

        Options.Add(new Option<bool?>(Constants.ALL_HOSTS_PARAMETER)
        {
